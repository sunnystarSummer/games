...
class Player extends ChangeNotifier {
  ...
  set combo(int value) {
    _combo = value;
    notifyListeners();
    broadcastHandCardChanges();
  }

  bool isScoreStreak = false;

  Stream<int> get comboCounter => _comboController.stream;
  final StreamController<int> _comboController = StreamController();
